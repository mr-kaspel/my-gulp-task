...
gulp.task('help', function() { //команда для запуска проекта "gulp mytask" вместо указания файла
		...
		console.log('1. (\x1b[33mready\x1b[0m) сборка итогового проекта в dist');
		console.log('2. (\x1b[33mbabel\x1b[0m) старый js');
		console.log('3. (\x1b[33msass\x1b[0m) приобразует .sass в .css');
		console.log('4. (\x1b[33mcss\x1b[0m) сжатие файлов .css (удаляет веб префиксы)');
		console.log('5. (\x1b[33mcsso\x1b[0m) минификация файлов .css (не удаляет веб префиксы)');
		console.log('6. (\x1b[33mun-css\x1b[0m) удаление не используемух селекторов');
		console.log('7. (\x1b[33mscripts\x1b[0m) сжимает/конкатенация .js файлы и libs.');
		console.log('8. (\x1b[33mimg\x1b[0m) сжимает изображений с учётом кэширования.(GIF, JPEG, PNG, SVG)');
		console.log('9. (\x1b[33msvg\x1b[0m) сжимает SVG.');
		console.log('10. (\x1b[33mwatch\x1b[0m) активирует отслеживание за изменениями файлов проекта.');
		console.log('11. (\x1b[33mbrowser-sync\x1b[0m) активирует локальный сервер.');
		console.log('12. Для установки библиотек введите (\x1b[33mbower i jquery\x1b[0m) (\x1b[33mbower i magnific-popup\x1b[0m)');
		console.log('13. (\x1b[33mclear\x1b[0m) чистим папку dist');
		console.log('14. (\x1b[33mclear-g\x1b[0m) чистим кеш Gulp');
		console.log('Для проверки пакетов на обновление команда (\x1b[33mncu\x1b[0m)');
